...
export function Navbar() {
  ...
  const isInEditor = location.pathname.startsWith("/resumes")

  return (
    <header className={cn("top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60", isInEditor ? "hidden" : "sticky")}>
